# -*- coding: utf-8 -*-
#
# django-find documentation build configuration file, created by
...
apidoc_exclude = [os.path.join('..', 'django_find', 'urls.py')]
main(['-d5', '-Mef', '-o', '.', '../django_find']
